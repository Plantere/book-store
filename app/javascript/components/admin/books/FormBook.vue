          ...
          <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl  my-8 w-full max-w-screen-lg">
            ...
            <form @submit.prevent="submit">
              ...
              <div class="flex flex-row">              
                <fieldset class="flex flex-col px-4 w-4/6">
                  <label for="title" class="text-sm font-medium leading-6 text-gray-900">Title</label>
                  <input id="title" v-model="bookData.title" required name="title" type="text" class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
                </fieldset>
                <fieldset class="flex flex-col px-4 w-2/6">
                  <label for="genre" class="text-sm font-medium leading-6 text-gray-900">Genre</label>
                  <select name="genre" id="genre" v-model="bookData.genre.id" required class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
              ...
              <div class="flex flex-row">
                <fieldset class="flex flex-col px-4 w-2/6">
                  ...
                  <input id="quantity" v-model="bookData.stock_quantity" required name="quantity" type="number" class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
                </fieldset>
                <fieldset class="flex flex-col px-4 w-2/6">
                  <label for="price" class="text-sm font-medium leading-6 text-gray-900">Price</label>
                  <input id="price" v-model="bookData.price" name="price" required type="text" class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
                </fieldset>
                <fieldset class="flex flex-col px-4 w-2/6">
                  <label for="status" class="text-sm font-medium leading-6 text-gray-900">Status</label>
                  <select name="status" id="status" v-model="bookData.status" required class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
              ...
              <div class="flex flex-row">
                <fieldset class="flex flex-col px-4 w-3/6">
                  ...
                  <select name="publisher" id="publisher" v-model="bookData.publisher.id" required class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
                ...
                <fieldset class="flex flex-col px-4 w-3/6">
                  ...
                  <select name="author" id="author" v-model="bookData.author.id" required class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
              ...
              <div class="flex flex-row">
                <fieldset class="flex flex-col px-4 w-full">
                  ...
                  <textarea id="description" v-model="bookData.description" name="title" required type="text" class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6"></textarea>
                </fieldset>
              </div>

              <div class="flex flex-row m-5 justify-end">
                <button type="submit" class="rounded-md bg-violet-600 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600">{{ bookData.id ? "Update" : "Create" }}</button>
              </div>
            </form>

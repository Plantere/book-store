            ...
            <form @submit.prevent="submit()">
              <div class="flex flex-row">              
                <fieldset class="flex flex-col px-4 w-4/6">
                  ...
                  <input id="full_name" v-model="authorData.full_name" required name="full_name" type="text" class="mt-2 mb-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6">
                </fieldset>
              ...
              <div class="flex flex-row m-5 justify-end">
                <button type="submit" class="rounded-md bg-violet-600 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600">{{ authorData.id ? "Update" : "Create" }}</button>
              </div>
            </form>

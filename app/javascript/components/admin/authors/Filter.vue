...
const emit = defineEmits(["search-author", 'create'])
...
watch(formSearch, (newValue) => {
  ...
  emit("search-author", formSearch.value, 1)
}, { deep: true });
...
<template>
  <div>
    ...
    <div class="flex flex-row justify-between px-5">
      <input type="text" placeholder="Search Authors" v-model="formSearch.search" class="w-full mr-5 rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-violet-600">
